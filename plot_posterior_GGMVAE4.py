...
model = GGMVAE4(channels=nchannels[args.dataset], dim_z=args.dim_z, dim_beta=args.dim_beta, dim_w=args.dim_w, K=args.K, arch=args.arch, device=device).to(device)
...
if args.dataset == 'celeba' or args.dataset == 'light_celeba' or  args.dataset == 'celeba_faces':
    ########################################################################################################################
